    ...
    public void onEnable() {
        ...
        BukkitRunnable runnable = new BukkitRunnable() {
            ...
            public void run() {
                ...
                String[] StrArray = {"","",""};
                if(dateToNextBilling.isEmpty()){
                    LocalDate today = LocalDate.now();
                    StrArray[0] = String.valueOf(today.getYear());
                    StrArray[1] = String.valueOf(today.getMonthValue());
                    StrArray[2] = String.valueOf(today.getDayOfMonth());
                    String date = StrArray[0]+"/"+StrArray[1]+"/"+StrArray[2];
                    transaction.updateWorldSetNextBillingDate(date, conn);
                }else {
                    StrArray = dateToNextBilling.split("/");
                }
