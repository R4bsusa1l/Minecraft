...
public class Claims extends JavaPlugin {
    ...
    public static HashMap<Player, Material> currentlyClaimingPrevBlockPlayerMap = new HashMap<>();
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(this.getCommand("setclaimname")).setExecutor(new SetClaimName(connectionActivity));
        Objects.requireNonNull(this.getCommand("getclaimlist")).setExecutor(new GetClaimList(connectionActivity));
